...
class KinematicVariables(VariableEnum):
    ...
    Omega = VarSpec('omega', 'rad / s', 1e-2, (-20000.0, 20000.0), 0, True)
    V_mag = VarSpec('V', 'm / s', 1e-2, (0.1, 700.0))
    V_mer = VarSpec('Vm', 'm / s', 1e-2, (0.1, 700.0))
    V_tan = VarSpec('Vt', 'm / s', 1e-2, (-700.0, 700.0))
    W_hub = VarSpec('W_hub', 'm / s', None, None, 0, True)
    W_mag = VarSpec('W', 'm / s', 1e-2, (0.1, 700.0))
    W_mer = VarSpec('Wm', 'm / s', 1e-2, (0.1, 700.0))
    W_tan = VarSpec('Wt', 'm / s', 1e-2, (-700.0, 700.0))
