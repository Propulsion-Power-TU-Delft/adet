...
class EndwallProperties(EquationBase):
    def residual(
        ...
        # Auxiliary variables
        delta_radius = geo_hh0 / 2 * np.cos(geo_meridional_angle0)
        r_hub = geo_rr0 - delta_radius
        r_tip = geo_rr0 + delta_radius
        ...
        r3 = kin_W_hub0 - (kin_Wm0**2 + Wt_hub**2) ** 0.5
        r4 = kin_W_tip0 - (kin_Wm0**2 + Wt_tip**2) ** 0.5
