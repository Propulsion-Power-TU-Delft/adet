...
class KinematicVariables(VariableEnum):
    ...
    W_presh = VarSpec('W_presh', 'm / s', None, None, 0, True)
...
class GeometricVariables(VariableEnum):
    ...
    ThroatArea = VarSpec('throat', 'm**2', 0.1)
...
class OtherVariables(VariableEnum):
    ...
    ChMassflow = VarSpec('ch_massflow', 'kg / s', 1.0, (1e-7, 5e4))
    ...
    ShockDeflection = VarSpec('sh_deflec', 'rad', 0.1, (-1.5, 1.5))
