...
class GeometricVariables(VariableEnum):
    ...
    MetalAngleHub = VarSpec('metal_angle_hub', 'rad', -0.3, (-1.5, 1.5), True)
    MetalAngleTip = VarSpec('metal_angle_tip', 'rad', -0.3, (-1.5, 1.5), True)
...
class OtherVariables(VariableEnum):
    ...
    CumMassFlow = VarSpec('cum_mf', 'kg / s', 20.0, (0.0, 5e4), 0, True)
